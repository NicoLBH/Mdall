...
const projectSubjectsEvents = createProjectSubjectsEvents({
  ...
  basculerLeMenuDesEpingles: (...args) => projectSubjectsView.basculerLeMenuDesEpingles(...args),
  fermerLeMenuDesEpingles: (...args) => projectSubjectsView.fermerLeMenuDesEpingles(...args),
...
const projectSubjectsView = createProjectSubjectsView({
  ...
  getChampsDesSujets: (...args) => getChampsDesSujets(...args),
  getCollaborateursDuProjet: (...args) => getCollaborateursDuProjet(...args),
  getMetaDesSujets: (...args) => getMetaDesSujets(...args),
  getSituationsDuProjet: (...args) => getSituationsDuProjet(...args),
  getMoiDansLeProjet: (...args) => getMoiDansLeProjet(...args),
  getRequeteDesSujets: (...args) => getRequeteDesSujets(...args),
