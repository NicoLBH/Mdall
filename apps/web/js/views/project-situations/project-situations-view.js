    ...
    return `
      <div class="svg-line-chart">
        <div class="svg-line-chart__frame">
          <svg class="svg-line-chart__svg svg-line-chart__svg--responsive" viewBox="0 0 ${width} ${height}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Distribution des sujets">
