...
export const TROU = {
  ...
  IMAGES_NON_LUES: "images-non-lues",
...
const PHRASES = {
  ...
  [TROU.IMAGES_NON_LUES]: "ce message porte des images collées dans son texte, qui n'ont pas été lues — dans un échange technique, une formule ou un extrait de norme s'y trouve souvent",
