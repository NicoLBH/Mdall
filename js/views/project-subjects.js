...
const SUBJECT_DEFAULT_LABEL_DEFINITIONS = [
  ...
  { key: "réserve", label: "réserve", description: "Point à lever ou à suivre avant clôture.", color: "rgba(251, 202, 4, 0.18)", textColor: "rgb(251, 202, 4)", borderColor: "rgba(251, 202, 4, 0.3)" },
  { key: "question", label: "question", description: "Clarification attendue sur ce point.", color: "rgba(212, 197, 249, 0.18)", textColor: "rgb(210, 195, 249)", borderColor: "a(210, 195, 249, 0.3)" },
